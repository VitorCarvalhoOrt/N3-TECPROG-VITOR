class Veiculo:
    ...
    def __str__(self):
            return(
                f'Placa: {self.__placa} | Marca: {self.__marca} | Modelo: {self.__modelo}| Ano: {self.__ano} | Valor de Mercado: {self.__valor_mercado}'
                )
    
class Carro(Veiculo):
    def __init__(self, placa, marca, modelo, ano, valor_mercado, numero_portas, tipo_carroceria):
        ...
        def calcular_imposto():
            return self.__valor_mercado * 0.1
